...
import { useFooterText } from '../../features/footer/hooks/useFooterText';
...
const TextContent: React.FC<{ type: string }> = ({ type }) => {
  const text = useFooterText({ type });
